...
$query="SELECT * FROM service_card ;";
 ...
 while($rez_array=  mysql_fetch_array($result))
{
 echo" </tr>
     <td>
     <button 
     onClick=\"card_edit($rez_array[card_index],'edit_card.php')\">Edit</button>
     <button type=\"button\" value=\"Delete\"
     onClick=\"delete_card($rez_array[card_index])\">Delete</button></td>
     </td>
...
echo "<button type=\"button\" value=\"New Card\"
    onclick=\"card_request('new_card.php')\">New Card";
?>
