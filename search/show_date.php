...
if($bef_aft=="start"){          
$query="SELECT * FROM service_card WHERE in_date >= '".$date."' ;";
}
if($bef_aft=="finish"){$query="SELECT * FROM service_card WHERE out_date <= '".$date."' ;";}
if($bef_aft=="Unfinished"){$query="SELECT * FROM service_card WHERE out_date='".$date."' ;";}
$result=mysql_query($query) or die('<br/>No entries!');
